...
export default function EditProfilePage() {
  ...
  const handleFileChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (name === 'other') setOtherFile(files[0]);
  };
  ...
  return (
    <div className="max-w-xl mx-auto bg-white p-6 rounded-2xl shadow-md mt-8">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          <label className="block text-sm font-medium text-gray-700">Otro archivo</label>
          <input
            type="file"
            name="other"
            accept="image/*,.pdf"
        ...
        {success && (
          <p className="text-center text-green-600 mt-3">Perfil actualizado correctamente ✅</p>
        )}
      </form>
    </div>
  );
