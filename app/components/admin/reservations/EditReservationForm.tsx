    ...
    <form onSubmit={onSubmit} className="grid gap-3 max-w-2xl">
      <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
        ...
        <label className="grid gap-1 text-sm">
          ...
          <select value={clientId} onChange={(e)=>setClientId(e.target.value)} className="rounded-md border px-3 py-2">
            <option value="">—</option>
      ...
      <label className="grid gap-1 text-sm">
        ...
        <select value={destinationId} onChange={(e)=>setDestinationId(e.target.value)} className="rounded-md border px-3 py-2">
          <option value="">—</option>
