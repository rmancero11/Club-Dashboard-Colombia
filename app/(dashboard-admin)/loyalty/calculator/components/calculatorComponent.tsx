...
interface CalculatorComponentProps {
  ...
  handleInputChangeQikstarts: (
    event: React.ChangeEvent<HTMLInputElement>
  ) => void;
  handleInputKeyUpQikstarts: (
      ...
      <div className="flex items-start gap-2">
        ...
        <div className="flex flex-col items-center justify-center">
          <div className="relative">
            <span className="absolute inset-y-0 left-0 flex items-center pl-3 text-stone-600 font-bold">
              $
            </span>
            <input
              type="number"
        ...
        <div className="flex items-center">
          <span className="mx-2 text-primary text-center text-2xl font-bold">
            =
          </span>
        </div>
        <div className="flex items-center">
          <span className="font-bold text-primary text-center py-1 text-xl">
